...
// Create an array called - var favoriteStartSayings that will store all the Favorite startup sayings once the "Favorite Startup" button is clicked.
...
// Once the print favorites button is clicked, you should see an array underneath the h2 with and ID of favorite that lists all of the favorite startups.